...
player.score ++;
score.innerText ="امتیاز شما : " +player.score;
...
{
    player.start=false;
    score.innerHTML="پایان بازی<br>امتیاز شما از این بازی :  "+player.score;
...
function gameSpeed()
{
    ...
    var e = document.getElementById("gamespeed");
    var gs = e.options[e.selectedIndex].value;
